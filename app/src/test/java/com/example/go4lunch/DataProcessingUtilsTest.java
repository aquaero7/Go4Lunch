...
public class DataProcessingUtilsTest {
    ...
    private void initializeData() {
        ...
        testRestaurantsWithDistance = DataProcessingUtils.updateRestaurantsListWithDistances(testRestaurants, refLatLng);
        testRestaurantsWithDistance0 = DataProcessingUtils.updateRestaurantsListWithDistances(testRestaurants0, refLatLng);
        testRestaurantsWithDistancePerNull = DataProcessingUtils.updateRestaurantsListWithDistances(testRestaurantsPerNull, refLatLng);
        testRestaurantsWithDistanceOpHoNull = DataProcessingUtils.updateRestaurantsListWithDistances(testRestaurantsOpHoNull, refLatLng);
    ...
    public void calculateRestaurantDistanceWithSuccess() {
        ...
        // Test distances
        double testDistance1 = DataProcessingUtils.calculateRestaurantDistance(testRestaurant1, refLatLng);
        double testDistance2 = DataProcessingUtils.calculateRestaurantDistance(testRestaurant2, refLatLng);
        double testDistance3 = DataProcessingUtils.calculateRestaurantDistance(testRestaurant3, refLatLng);
        double testDistance4 = DataProcessingUtils.calculateRestaurantDistance(testRestaurant4, refLatLng);
        // Test verifications
    ...
    public void calculateBoundsWithSuccess() {
        ...
        // Test bounds
        LatLngBounds testBounds = DataProcessingUtils.calculateBounds(new LatLng(refLat,refLng), refRadius);
    ...
    public void updateRestaurantsListWithDistancesWithSuccess() {
        ...
        List<RestaurantWithDistance> restaurantsWithDistance = DataProcessingUtils.updateRestaurantsListWithDistances(testRestaurants, refLatLng);
        // Test verifications
    ...
    public void sortByDistanceAndNameWithSuccess() {
        ...
        // Test sort
        DataProcessingUtils.sortByDistanceAndName(testRestaurants);
        // Test verifications
    ...
    public void sortByNameWithSuccess() {
        ...
        // Test sort
        DataProcessingUtils.sortByName(testUsers);
        // Test verifications
    ...
    public void sortByAscendingOpeningTimeWithSuccess() {
        ...
        // Test ascending sort
        DataProcessingUtils.sortByAscendingOpeningTime(testPeriods);
        // Test verifications
    ...
    public void sortByDescendingOpeningTimeWithSuccess() {
        ...
        assertEquals("Wrong order", op2, testPeriods.get(3).getOpen().getTime());
        // Test ascending sort
        DataProcessingUtils.sortByDescendingOpeningTime(testPeriods);
        // Test verifications
        // New list order expected : Period opening time 1-2-3-4
