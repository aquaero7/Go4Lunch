...
public interface GmapsApiInterface {
    ...
    // We use List<GmapsRestaurantPojo> in callback because the data in the API is starting from JSONArray
    ...
    // GmapsRestaurantDetailsPojo is POJO class to get the data from API
    // We use List<GmapsRestaurantDetailsPojo> in callback because the data in the API is starting from JSONArray
