...
public class UserHelper {
    ...
    public UserHelper(FirebaseFirestore firebaseFirestore,
                      FirebaseAuth firebaseAuth, AuthUI authUI) {
        this.firebaseFirestore = firebaseFirestore;
        this.firebaseAuth = firebaseAuth;
        this.authUI = authUI;
    }

    public static UserHelper getNewInstance(FirebaseFirestore firebaseFirestore,
                                            FirebaseAuth firebaseAuth, AuthUI authUI) {
